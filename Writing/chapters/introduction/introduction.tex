...
My first web application was a Python Flask application with a simple backend, frontend, a database connected to it, and a few API calls.
I thought that web development was simpler than it sounds. However, as I learned more about 
the frontend and the backend side of web applications, I changed my mind.
...
The more I learn, I observed that several design choices could be made in every situation.
Realizing that I could not always answer “why this specific choice?” for some of the decisions I made highlighted that my understanding of the available options in web development was incomplete, which led me to further research this topic.
...
Another important topic is database systems. I took the database class during my sophomore year, but using databases in web development required much deeper knowledge.
The types of databases to choose, ways to structure the database for performance and scalability were always a confusion for me.
To fully understand the decisions I am making, I researched this topic to make logical decisions in the future when creating applications.
...
Caching data from database queries or API calls often makes the application significantly faster, 
...
I developed a cuisine recommender web application called the Local Cuisine App to show the knowledge and research done in these areas.
...
but rather recommends restaurants. Going straight to the restaurants can work,
...
This needs a two-step search: first on a search engine such as Google to find the famous food in the area, and second, searching the name of the dish on Google Maps.
The purpose of the Local Cuisine application is to make the process of searching restaurants more efficient, as well as allowing users to explore diverse cuisines in the world.

This work is structured as follows: Chapters 2, 3, and 4 will investigate the theories of topics that I have chosen, 
...
is implemented, and the design choices made based on the theory introduced in the previous chapters. The outcome and explanation of the final software will be addressed in 
chapter 6, including snapshots and images of the web application. Chapter 6 will also include the conclusion and the challenges throughout the whole research project and the lessons learned.
