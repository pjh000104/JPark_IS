...
The table \ref{tab:order_before_1nf} shows the example of a table before the first normalized form. We can see that students have multiple classes in the same column separated by a comma.
