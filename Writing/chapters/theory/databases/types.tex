...
There are mainly two types of databases that are used in software engineering: Relational and non-relational databases. 
These two databases differ by how they store and data, which influences different aspects if databases including the structure, data integrity mechanism, performance and more. 
...
Nonrelational databases are characterized by their flexible or schema-optional data models, meaning that a rigid, predefined schema is not mandatory.
Schema is a blueprint of a database describes the relationship between data, tables, or other data modules.
