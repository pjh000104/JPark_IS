...
Figure \ref{fig:regions-page} illustrates the main page, where users are able to explore multiple geographic regions.
...
Once a region is selected, users are able to see the popular cuisines that represent the area as shown in Figure \ref{fig:cuisines-page}.

\cuisinesFigure

When a user selects a specific cuisine, the user is directed to the detailed 
cuisine page Figure \ref{fig:rdetailed-cuisines-page}. Details about the cuisine, such as its description
