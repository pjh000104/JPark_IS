...
\begin{abstract}
This paper explores the design choices that could be made in the backend side of web applications,
focusing on software architecture and principles, databases, and caching strategies.
The study combines theoretical research from textbooks, academic sources, and online technical resources with practical experimentation,
resulting in the development of a web application as a proof of concept.
Through this process, the study demonstrates a comprehensive understanding of backend systems, highlighting key considerations in backend architecture and data management.
While some theoretical approaches could not be fully applied due to project and time constraints,
the project provided valuable insights into the practical implementation and limitations of backend web applications.
\end{abstract}
...
\begin{acknowl}  
I would like to acknowledge professor Drew Guarnera in the MCS Department for his suggestions and code.
\end{acknowl}
...
\input{chapters/theory/chapter1}
\input{chapters/implementation/chapter2}
\input{chapters/result/chapter3}
